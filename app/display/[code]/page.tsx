  ...
  return (
    <div className="p-6 max-w-3xl" dir="rtl">
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle>1. בחר מחלקה</CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            ...
            {image && (
              <Button
                ...
                disabled={isAnalyzing || !selectedDept}
              >
                {isAnalyzing ? (
                  <><Loader2 className="h-4 w-4 animate-spin" /> מנתח את הלוח...</>
                ) : (
                  "נתח עם AI"
                )}
              </Button>
            ...
            {!selectedDept && image && (
              <p className="text-sm text-amber-600 mt-2">בחר מחלקה תחילה</p>
            )}
          </CardContent>
        </Card>
            ...
            <CardContent className="space-y-3">
              ...
              {isDone ? (
                <div className="flex items-center gap-2 text-green-600 font-medium">
                  ...
                  נשמר בהצלחה! עובר לרשימת פעילויות...
                </div>
              ) : (
                <Button className="w-full gap-2" onClick={saveActivities} disabled={isSaving}>
                  {isSaving ? (
                    ...
                    `שמור ${activities.length} פעילויות`
                  )}
                </Button>
              )}
            </CardContent>
