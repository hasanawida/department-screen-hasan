    ...
    <div dir="rtl" className="min-h-screen bg-slate-50 p-6 md:p-10">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-black text-slate-900">מסכי מחלקות</h1>
            <p className="mt-1 text-lg text-slate-500">ניהול מסכי התצוגה לכל המחלקות</p>
          </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500 mt-1">/display/{dept.code}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <Link
                      href={`/admin/display-settings/${dept.code}`}
