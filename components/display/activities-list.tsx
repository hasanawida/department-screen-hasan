...
import { Clock, MapPin, User, Users, ChevronDown, ChevronUp, Image } from "lucide-react"
              ...
              >
                ...
                {isSelected && (
                  <div className="px-4 pb-4 border-t pt-3 space-y-3">
                    ...
                    {isCurrent && (
                      <div
                        className="px-3 py-1 rounded-full text-sm font-medium w-fit text-white"
